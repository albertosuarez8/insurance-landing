      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start">
          ...
          <AnimateIn className="lg:sticky lg:top-28">
            <div className="inline-flex items-center gap-2 rounded-lg border border-brand-400 bg-toggle/80 px-3 py-1.5 text-center lg:inline-flex">
          ...
          <label className="mt-3 flex cursor-pointer items-start gap-2">
            ...
            <span className="text-sm text-slate-600">
              ...
              <a
                href="https://boaprinsurance.com/wp-content/uploads/2025/11/Politica-de-Priviacidad-Boapr-Insurance.pdf"
                target="_blank"
